...
export namespace Utils {
   ...
   */
  export const isYes = (input: string): boolean => input.toLowerCase() === 'yes'
    || input.toLowerCase() === 'y'
   ...
   */
  export const isDefinedFilter = <T>(input: T | undefined | null): input is T => typeof input !== 'undefined' && input !== null;
   ...
   */
  export const isInFuture = (date: Date): boolean => date > new Date();
   ...
   */
  export const isInPast = (date: Date): boolean => date < new Date();
   ...
   */
  export const isNowBetween = (dateStart: Date, dateEnd: Date): boolean => {
